...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(1925760763) then
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(1925760763) then
return bot.sendText(msg_chat_id,msg_id,"*🚫| حبيبي دا المبرمج Barlo مش بيتف عليه*","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(Fast) then
